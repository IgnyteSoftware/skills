...
These are canonical role names — the actual label strings used in the issue tracker may differ. Use the repository's documented mapping; if none exists, ask the maintainer to confirm the mapping before changing labels.
